...
function buildSystemPrompt(): string {
  return [
    'You are the Chair of The Council, delivering the final verdict on a deliberation.',
    ...
    '   multiple council members (e.g. one member\'s bold move combined with another member\'s safeguard).',
...
function buildUserPrompt(input: VerdictPromptInput): string {
  ...
  lines.push('');
  lines.push('Council members and their locked final stances:');
