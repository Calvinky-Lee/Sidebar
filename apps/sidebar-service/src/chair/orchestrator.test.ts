...
import { PersonaCastPayloadSchema } from '@sidebar/contract';
...
describe('orchestrator — happy path, all 4 members', () => {
  ...
  it('emits persona_cast payloads that satisfy the real @sidebar/contract schema', async () => {
...
describe('orchestrator — recusals drop below the minimum viable sidebar', () => {
