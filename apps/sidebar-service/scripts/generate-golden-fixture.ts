 ...
 *
 * Run: pnpm --filter @sidebar/service fixture:golden
 */
import { writeFile } from "node:fs/promises";
import { fileURLToPath } from "node:url";
import path from "node:path";
import { ContractEventSchema, type ContractEvent, type Stance } from "@sidebar/contract";
...
function main() {
  ...
  push("casting_started", { poolSize: 24, sidebarSize: 4 }, 900);
