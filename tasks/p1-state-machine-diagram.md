...
Implementation: [`apps/council-service/src/chair/state-machine.ts`](../apps/council-service/src/chair/state-machine.ts).
...
- Minimum viable council: **2 active members**.
...
event into the state machine if the council has fallen below the minimum.
